...
<body>
    ...
    <input type="text" name="date_of_birth"  placeholder="Date of Birth" id="date_of_birth" required class="input-field">
...
dateOfBirthInput.addEventListener('blur', function() {
  if (!dateOfBirthInput.value) {
    ...
    dateOfBirthInput.value = 'Date of Birth';
    
  }
});
</script>
<br> 
            <p>Or <a href="RegisterRecruiter">register as a recruiter</a>.</p>
        </div>
